...
<div class="pagetitle">
  ...
  <div class="container">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="number" name="contact" id="contact" class="form-control @error('contact') is-invalid @enderror" value="{{@old('contact')}}">
        @error('contact')
            <p style="color: red">{{$message}}</p>
        @enderror
        ...
        <label for="picture">Entrer un photo de notre employé(e)</label>
